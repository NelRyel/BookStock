...
namespace StockEntModelLibrary
{
    ...
    {
        public StockDBcontext() : base(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=E:\BookStock\web\WebServer\StockEntModelLibrary\BookDB.mdf;Integrated Security=True")
        {
